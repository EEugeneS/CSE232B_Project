...
public interface XQueryVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link XQueryParser#xqMain}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitXqMain(XQueryParser.XqMainContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link XQueryParser#xqValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
